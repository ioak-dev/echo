    ...
    <div className="getting-started">
      <div>
        ...
        <div className="getting-started--steps realm-top-2">
          ...
          <div className="typography-7">Set Echo URL in your product</div>
          <div className="typography-4">
            To provide seemless experience to your users, add a link from your
            product to Echo. By triggering a button for example from your
            product, your users will be securely transferred to Echo with
            their details.
          </div>
          <div className="typography-7">
            Securely transmit user information to Echo
          </div>
          <div className="typography-4">
